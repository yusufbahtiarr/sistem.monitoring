<?php
if ($_GET['act']=="delete") {
	$q = "DELETE FROM proyek WHERE id_proyek={$_GET['id_proyek']};";
	mysql_query($q);
?>
<script type="text/javascript">
	document.location = "index.php?mod=data_proyek";
</script>
<?php
}
switch ($_GET['form']) {
		...
		if (bagian=="proyek"&&aksi=="ubah") {
			...
			jQuery.ajax({
				...
				data:{
					...
					status:$("#status").val(),
					tingkat_kesulitan:$("#tingkat_kesulitan").val(),
				},
...
<a href="?mod=data_proyek">back</a><br>
...
?>
					...
					<table class="table table-bordered">
						<thead>
							...
							<th width="8%" class="tengah">TRENCHING (M)</th>
							<th width="8%" class="tengah">JEMBATAN (M)</th>
							<th width="8%" class="tengah">JOINBOX (Qty)</th>
							<th width="8%" class="tengah">PULLING (M)</th>
							<th width="8%" class="tengah">SPLICING (Qty)</th>
							<th width="8%" class="tengah">ATP (Qty)</th>
				...
				<div class="panel-body lebihkecil">
					<table class="table table-bordered">
						<thead>
							...
							<th width="180" align="center">AS BUILT DRAWING (Qty)</th>
							<th width="180" align="center">BOQ (Qty)</th>
							<th width="180" align="center">DOKUMEN ATP (Qty)</th>
							<th width="180" align="center">DOKUMEN OTDR (Qty)</th>
							<th align="center"></th>
						</thead>
...
<?php
	...
	case 'insert':
		$query = "INSERT INTO proyek
					(operator,nama_proyek,tgl_mulai,tgl_akhir,status,tingkat_kesulitan) VALUES
					('".$_POST['operator']."','".$_POST['nama_proyek']."','".$_POST['tgl_mulai']."','".$_POST['tgl_akhir']."','".$_POST['status']."','".$_POST['tingkat_kesulitan']."');";
		$result = mysql_query($query);
		$id_proyek = mysql_insert_id();
		if ($result) {
			$query = "INSERT INTO civil_bobot (id_proyek,trenching,jembatan,joinbox,pulling,splicing,atp) VALUES ($id_proyek,50,20,5,15,5,5);";
			mysql_query($query);
?>
<script type="text/javascript">
...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<br><br><br>
		<form action="?mod=data_proyek&act=filter" method="POST">
			<table class="form">
				<tr>
					<td class="kanan">STATUS</td>
					<td>
...
?>
				<tr>
					...
					<td width="180px">
						<a href="?mod=data_proyek&form=detil&id_proyek=<?php echo($data['id_proyek']); ?>" title="detil">
							<button class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-tasks"></span> detil</button>
						</a>
						<a href="?mod=data_proyek&act=delete&id_proyek=<?php echo($data['id_proyek']); ?>" title="delete"
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<tr>
					...
					<td>
						<select name="tingkat_kesulitan">
							...
							<option value="NORMAL">SULIT</option>
						</select>
					</td>
				</tr>
				<!-- <tr>
				...
				<tr>
					<td class="kanan">Tanggal Akhir</td>
					<td><input type="text" name="tgl_akhir" class="datepicker"></td>
				</tr>
				<tr>
					<td class="kanan">Status</td>
					<td>
