...
<?php
	...
	$query = "UPDATE user SET nik='".$_POST['nik']."', nama='".$_POST['nama']."', nm_belakang='".$_POST['nm_belakang']."', hak_akses='".$_POST['hak_akses']."', password='".$_POST['password']."', hp='".$_POST['hp']."', email='".$_POST['email']."' WHERE id_user=".$id_user;
	mysql_query($query);
?>
<script type="text/javascript">
...
?>
<div class="panel panel-default">
	<div class="panel-heading"><strong>View Profile - </strong><a href="?mod=view_karyawan&id_user=<?php echo($_SESSION['id_user']); ?>&act=edit">edit
		</a></div>
...
?>
<div class="panel panel-default">
	<div class="panel-heading"><strong>Cari User </strong></div>
	<div class="panel-body">
<?php
...
?>
				...
				<tr>
					...
					<td>
						...
						<button type="submit" class="btn btn-success" name="act" value="add"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Tambah Data</button>
					</td>
				</tr>
			</table>
		</form>
